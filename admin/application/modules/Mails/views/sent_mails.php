    ...
    <div class="row">
        ...
        <div class="col-lg-9 animated fadeInRight" style="overflow-y: -webkit-paged-x; overflow-x: hidden;">
            <div class="mail-box-header">
                ...
                <h2>
                    Sent Mails (<span class="num_sentMails">0</span>)
                </h2>
                <div class="mail-tools tooltip-demo m-t-md">
                    ...
                    <button class="btn btn-white btn-sm" onclick="sent_mails_load(0)"><i class="fa fa-refresh"></i> Refresh</button>
            ...
            <div class="loader_main">
                <div class="loader_load" id="sentmail_load_loader"></div>
...
<script>
    function sent_mails_load(from=0){
        $("#sentmail_load_loader").show();
        $.ajax({
            type: 'post',
            url: 'sent_mails_load',
            data: {'from':from},
