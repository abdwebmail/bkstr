    ...
    <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="ibox" id="loader">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Buying Request Detail [ <small><?=$req_detail->client_name?></small> ]</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6" id="cluster_info">
                                    ...
                                    <dl class="row mb-0">
                                        ...
                                        <div class="col-sm-8 text-sm-left">
                                            <dd class="mb-1"><span class="text-navy"><?=$req_detail->product_model?></span></dd>
                                        </div>
                                    </dl>
                                    <dl class="row mb-0">
                                        <div class="col-sm-4 text-sm-right">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="ibox" id="loader">
                    <div class="ibox-title">
                        <h5>Evaluation Comment <small> Write comment about this Buying Request</small></h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
                    ...
                    <div class="ibox-content">
                        <form id="sale_status-form">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" placeholder="0" class="form-control" name="buying_price" id="buying_price" value="<?=$req_detail->buying_price?>">
                                </div>
                            </div>
                            <div class="form-group row">
...
<script>
    ...
    $("#sale_status-form").submit(function(event){
        ...
        var buying_price        = $('#buying_price').val().trim();
        var evaluation_status   = $('#evaluation_status').val();
        if (buying_price == '') {
            $("#fields_check_status").show();
            $("#fields_check_status").text("Please provide Buying Price");
            $("#buying_price").focus();
            return;
        }
        ...
        formData.append('req_id','<?=$req_detail->id?>');
        $.ajax({
            url: '<?=base_url()?>update_buying_status',
            type: 'POST',
            data: formData,
            dataType: 'json',
            success: function (res) {
